...
export default async function BuscarOT() {
  ...
  const { data: ots } = await supabase
    ...
    .select(
      "id, folio, estado, tipo_lente, tratamiento, posicion, tipo_lente_2, tratamiento_2, posicion_2, fecha_ingreso, fecha_entrega_real, pacientes:paciente_id (nombre, rut)"
    )
